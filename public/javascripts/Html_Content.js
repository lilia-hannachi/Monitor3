...
function roa_prefix_submit()
{
	...
	if(hour == "" || time == "" || origin == "" || prefix=="")
        {
                alert("Prefix, Origin and Date must be filled out+++++++",time,"-----", hour);
        }
	else
	{
...
//    var result ='<div class="col-md-'+col+'"><div class="card card-info"><div class="card-header">';
    var result = '<div class="col-md-12"><div class="card card-info"><div class="card-header">';    
    result += '<div class="header-block"><h5 class="title">'+ param["global_title"] +'</h5></div></div>';
