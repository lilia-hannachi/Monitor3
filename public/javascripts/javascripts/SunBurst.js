...
function generateSunBurst(version, setData, divName, legendDiv, total, title, legendY)
{
...
function drawPie(title)
{
        ...
        svg = d3.select("#" + config.divId)
                ...
                .attr("viewBox", "-80 0 550 550")
                .classed("svg-content-responsive", true);
        var widthRadius = radius + 10;
        var heightRadius = radius - 10;
   ...
   svg.append("text")
          .attr("x", -20)
          .attr("y", donut_height * config.legendY + 40 )
          .style("font-size", "8px")
...
function generateLegend()
{
        ...
        var dataL = width / labels.length-30;
        var offset = 60;
